...
function rooturl (req, res, postdata, pathname) {
console.log('handle ->rooturl- is called!');
var indexHtml = fs.readFileSync('././asset/index.html');

res.writeHead(200, {'Content-Type': 'text/html; charset=utf-8'});
res.write(indexHtml);
res.end();
}
function start (req, res, postdata, pathname) {
...
function upload (req, res, postdata, pathname) {
console.log('handle -start- is called!');
...
function show (req, res, postdata, pathname) {
...
function dealcssurl (req, res, postdata, pathname) {
console.log(postdata);
console.log('handle ->dealcss- is called!');
var indexHtml = fs.readFileSync('././asset'+pathname);
...
function dealjsurl (req, res, postdata, pathname) {
console.log(postdata);
...
function dealimgurl (req, res, postdata, pathname) {
console.log(postdata);
...
function dealjsonurl (req, res, postdata, pathname) {
console.log(postdata);
...
function dealhtmurl (req, res, postdata, pathname) {
console.log(postdata);
...
function dealfalsejsonurl (req, res, postdata, pathname) {
	console.log(postdata);
	console.log('handle ->dealfalsejsonurl- is called!');
	var indexHtml = fs.readFileSync('././'+pathname+'/'+req.method+'.json');
...
exports.dealfalsejsonurl = dealfalsejsonurl;